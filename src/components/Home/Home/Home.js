...
const Home = () => {
    return (
        <>
        <div className='container pt-6 pb-64 mx-auto'>
            ...
            <input className='p-2 rounded-tl-md rounded-bl-md focus:outline-none w-full' type="text" name="search" placeholder='search...' required/>
